...
async function loadData() {
  ...
  } catch (error) { if (requestId === dataRequestId) { if (isTaYield) renderTaYieldTendencyLoadError(error.message); setStatus(error.message); } } finally { setReportControlsLoading(false); if (requestId === dataRequestId) apply.textContent = 'Apply'; }
}
